...
export default class RegisterView extends React.Component {
    ...
    isDisabled() {
        ...
        if (this.state.password === '' || !this.state.password) {
         ...
         if (this.state.password_confirm === '' || !this.state.password_confirm) {
            this.setState({
                password_confirm_error_text: null,
            });
            ...
            this.setState({
                password_confirm_error_text: 'The password you entered do not match.',
            });
                    ...
                    <div className="text-center">
                        ...
                        <div className="col-md-12">
                         ...
                         <div className="col-md-12">
                                <TextField
                                  ...
                                  type="string"
                                  onChange={(e) => this.changeValue(e, 'company')}
                                />
                            </div>
                        <div className="col-md-12">
                            <TextField
                        ...
                        <div className="col-md-12">
                            <TextField
                              ...
                              onChange={(e) => this.changeValue(e, 'password_confirm')}
                            />
                        </div>
                        <RaisedButton
